...
find package/feeds/luci/luci-app-openvpn/ -name "*.lua"|xargs sed -i 's/\"vpn\"/\"services\"/g'
find package/feeds/luci/luci-app-openvpn/ -name "*.lua"|xargs sed -i 's/admin\/vpn/admin\/services/g'
find package/feeds/luci/luci-app-openvpn/ -name "*.htm"|xargs sed -i 's/\"vpn\"/\"services\"/g'
find package/feeds/luci/luci-app-openvpn/ -name "*.htm"|xargs sed -i 's/\[vpn\]/\[services\]/g' 
find package/feeds/luci/luci-app-openvpn/ -name "*.htm"|xargs sed -i 's/admin\/vpn/admin\/services/g'
find package/feeds/luci/luci-app-openvpn/ -name "*.lua"|xargs sed -i 's/\"VPN\"\,\ 45/\"Services\"\,\ 45/g'
find package/feeds/luci/luci-app-openvpn/ -name "*.lua"|xargs sed -i 's/\"services\"\,\ 45/\"Services\"\,\ 45/g'

find package/lean/luci-app-openvpn-server/ -name "*.lua"|xargs sed -i 's/\"vpn\"/\"services\"/g'
find package/lean/luci-app-openvpn-server/ -name "*.lua"|xargs sed -i 's/admin\/vpn/admin\/services/g'
find package/lean/luci-app-openvpn-server/ -name "*.htm"|xargs sed -i 's/\"vpn\"/\"services\"/g'
find package/lean/luci-app-openvpn-server/ -name "*.htm"|xargs sed -i 's/\[vpn\]/\[services\]/g' 
find package/lean/luci-app-openvpn-server/ -name "*.htm"|xargs sed -i 's/admin\/vpn/admin\/services/g'
find package/lean/luci-app-openvpn-server/ -name "*.lua"|xargs sed -i 's/\"VPN\"\,\ 45/\"Services\"\,\ 45/g'
find package/lean/luci-app-openvpn-server/ -name "*.lua"|xargs sed -i 's/\"services\"\,\ 45/\"Services\"\,\ 45/g'
